...
.modal-title .content h2 span {
  color: #ef4444;
}

.modal-title .content > span {
  display: block;
  color: #4b5563;
  font-size: 14px;
...
.modal-container-content:last-child {
  border-block-end: 0;
}
